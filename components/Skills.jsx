...
function Skills() {
  return (
    <div className='bg-[#232325] w-[90%] mt-5 mx-auto max-h-full px-5 shadow-md flex flex-col gap-2 rounded-lg'>
...
const SkillsCard = ({ skillsType, skillsPercentage }) => {
  return (
    <div className='flex flex-col justify-center p-5 mx-5 gap-2'>
